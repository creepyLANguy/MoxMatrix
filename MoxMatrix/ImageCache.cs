namespace MoxMatrix
{
  public class ImageCache
  {
    ...
    {
      if (cardName.Length == 0 || image == null)
      {
        return;
      }
    ...
    //AL.
    //TODO - implement a way to stop this thread (when the form is closed, when the cardNames list is updated, on exceptions and failures, etc).
